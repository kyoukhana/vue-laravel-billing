...
var tokenHeaders = {
  ...
  stripeKey: document.head.querySelector('meta[name="stripekey"]')

};

if (tokenHeaders.csrfToken.content) {
  window.axios.defaults.headers.common['X-CSRF-TOKEN'] = tokenHeaders.csrfToken.content;
  window.axios.defaults.headers.common['stripeKey'] = tokenHeaders.stripeKey.content;
} else {
...
Component.options.__file = "/www/billing/resources/assets/js/components/CheckoutForm.vue"
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('form', {
    ...
    }, [_vm._v(_vm._s(product.name) + " – $" + _vm._s(product.price / 100))])
  })), _vm._v(" "), _c('button', {
    attrs: {
      "type": "submit"
    },
